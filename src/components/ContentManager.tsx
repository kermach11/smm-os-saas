            ...
            const onSeeked = () => {
              ...
              try {
                ...
                if (!hasResolved) {
                  hasResolved = true;
                  cleanup();
                                  // Використовуємо красивішу заставку для відео
                videoResolve('data:image/svg+xml;base64,');
                }
              }
            };
