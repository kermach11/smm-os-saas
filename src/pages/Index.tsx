...
const Index = () => {
  ...
  useEffect(() => {
    const initializeAllMedia = async () => {
      // ВИПРАВЛЕННЯ: Захист від повторного виконання на мобільних
      if (screenState === 'main' && hasInitialLoadCompleted) {
        console.log('🛡️ UnifiedPage: Пропускаємо ініціалізацію - вже на головній сторінці');
        return;
      }
