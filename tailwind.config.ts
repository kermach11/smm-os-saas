	...
	theme: {
		...
		extend: {
			...
			fontFamily: {
				...
				'sans': ['SF Pro Text', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', 'sans-serif'],
			},
			transitionProperty: {
			...
			animation: {
				...
				'subtle-glow': 'subtle-glow 4s infinite ease-in-out',
